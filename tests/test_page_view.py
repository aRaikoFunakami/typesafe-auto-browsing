...
from typesafe_auto_browsing.page_view import describe_part, split_parts, view_page
...
def test_long_page_shows_chosen_parts_in_order_and_unchanged():
    ...
    view = asyncio.run(view_page(Client(), "goal", [], page, 10_000))
...
def test_label_names_controls_first():
    ...
    assert describe_part(part).startswith("controls: combobox 並べ替え")
